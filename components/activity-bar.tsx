        ...
        <MotionConfig transition={transition}>
            <div className="z-[100] position absolute top-10 right-5 flex flex-col items-end gap-2 text-black/40 dark:text-white/50">
                ...
                {currentTab !== "" && <Squircle
                    ...
                    cornerRadius={40}
                    cornerSmoothing={1}
                    className="text-black/40 dark:text-white/50 backdrop-blur-[50px] cursor-pointer p-5"
                >
                    <motion.div className=" bg-white/50 dark:bg-[#1E1E1E]/50 transition-[width] duration-500">
