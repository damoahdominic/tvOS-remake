  ...
  main: [
    {
      ...
      description: "Language, Time Zone, Accessibility",
    },
    {
      id: "privacy",
      ...
      description: "Tracking, Location Services, Analytics",
    },
    {
      id: "screen",
      label: "Screen & Display",
      hasSubmenu: true,
      icon: SettingsIcons.screen,
      description: "Resolution, Calibration, HDMI settings",
    },
    {
      id: "audio",
      label: "Audio & Video",
      ...
      description: "Dolby Atmos, Audio Format, Volume",
    },
    {
      id: "network",
      label: "Network",
      ...
      description: "Wi-Fi, Ethernet, Connection status",
    },
    {
      id: "apps",
      label: "Apps",
      ...
      description: "Installed apps, Storage, Permissions",
    },
    {
      id: "accounts",
      label: "Accounts",
      hasSubmenu: true,
      icon: SettingsIcons.accounts,
      description: "Apple ID, Users, Profiles",
    },
    {
      id: "about",
      label: "About",
      ...
      description: "System information, Legal, Regulatory",
    },
  ],
  general: [
    {
      ...
      description: "System language and region",
    },
    {
      id: "time",
      label: "Time Zone",
      hasSubmenu: false,
      description: "Automatic or manual time settings",
    },
    {
      id: "keyboard",
      label: "Keyboard",
      hasSubmenu: false,
      description: "Layout, suggestions, dictation",
    },
    {
      id: "accessibility",
      label: "Accessibility",
      hasSubmenu: true,
      description: "Vision, hearing, motor settings",
    },
    {
      id: "reset",
      label: "Reset",
  ...
  privacy: [
    {
      ...
      hasSubmenu: false,
      description: "Control how apps request to track you",
    },
    {
      id: "location",
      label: "Location Services",
      hasSubmenu: false,
      description: "Manage which apps can access your location",
    },
    {
      id: "analytics",
      label: "Analytics & Improvements",
      hasSubmenu: false,
      description: "Share usage data with Apple",
    },
    {
      id: "ads",
      label: "Apple Advertising",
      hasSubmenu: false,
      description: "Personalized ads in Apple apps",
    },
  ],
  screen: [
    {
      ...
      label: "Resolution",
      hasSubmenu: false,
      description: "Set screen resolution (4K, 1080p, etc.)",
    },
    {
      id: "calibration",
      label: "Calibration",
      hasSubmenu: false,
      description: "Calibrate color and brightness",
    },
    {
      id: "hdmi",
      label: "HDMI Settings",
      hasSubmenu: false,
      description: "HDMI-CEC, Range, Format",
    },
    {
      id: "appearance",
      label: "Appearance",
  ...
  audio: [
    {
      ...
      label: "Audio Format",
      hasSubmenu: false,
      description: "Dolby Atmos, Stereo, etc.",
    },
    {
      id: "volume",
      label: "Volume",
    ...
    },
    {
      ...
      hasSubmenu: false,
      description: "Subtitle style and language",
    },
    {
      id: "soundeffects",
      label: "Sound Effects",
      hasSubmenu: false,
      description: "Navigation clicks, sound feedback",
    },
  ],
  network: [
    {
    ...
    },
    {
      ...
      label: "Ethernet",
      hasSubmenu: false,
      description: "Wired network settings",
    },
    {
      id: "status",
      label: "Connection Status",
      hasSubmenu: false,
      description: "View current network status",
    },
    {
      id: "advanced",
      label: "Advanced",
      hasSubmenu: false,
      description: "IP, DNS, Proxy, etc.",
    },
  ],
  apps: [
    {
      ...
      hasSubmenu: false,
      description: "Manage or uninstall apps",
    },
    {
      id: "storage",
      label: "Storage",
  ...
  accounts: [
    {
      ...
      label: "Apple ID",
      hasSubmenu: false,
      description: "Manage your Apple ID",
    },
    {
      id: "users",
      label: "Users & Profiles",
      hasSubmenu: false,
      description: "Switch or add users",
    },
    {
      id: "subscriptions",
      label: "Subscriptions",
  ...
  about: [
    {
      ...
      hasSubmenu: false,
      description: "Device name, model, serial number",
    },
    {
      id: "legal",
      label: "Legal",
      hasSubmenu: false,
      description: "Licenses, terms, and conditions",
    },
    {
      id: "regulatory",
      label: "Regulatory",
...
const Page = () => {
  ...
  const [previousFocusMap, setPreviousFocusMap] = useState<{
    [key: string]: number;
  }>({});
  ...
  const navigateForward = (menuId: string) => {
    if (settingsData[menuId]) {
      ...
      setFocusedIndex(
        previousFocusMap[menuId] !== undefined ? previousFocusMap[menuId] : 0
      );
    }
  };
            ...
            <AnimatePresence mode="wait">
              ...
              >
                {currentMenuItems[focusedIndex]?.description ? (
                  ...
                  <p className="text-xs">
                    Use arrow keys to navigate • Press right arrow or Enter to
                    select • Press left arrow or Esc to go back
                  </p>
                )}
              </motion.div>
            </AnimatePresence>
